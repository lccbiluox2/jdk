...
public final class URI implements Comparable<URI>, Serializable {
     ...
     */
    // 相对化：如果当前URI中包含了otherUri，则返回一个相对URI，通过该相对URI，可以从当前URI访问到otherUri，否则，直接返回otherUri
     ...
     * @throws IllegalArgumentException If the given string violates RFC&nbsp;2396
     */
    // 绝对化：基于当前URI解析otherUri；如果otherUri是相对URI，则返回"当前URI+otherUri"，如果otherUri是绝对URI，原样返回
