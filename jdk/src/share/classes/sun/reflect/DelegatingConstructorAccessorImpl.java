 ...
 */
class DelegatingConstructorAccessorImpl extends jdk.internal.reflect.ConstructorAccessorImpl {
    private jdk.internal.reflect.ConstructorAccessorImpl delegate;   // 被代理的构造器访问器

    DelegatingConstructorAccessorImpl(jdk.internal.reflect.ConstructorAccessorImpl delegate) {
    ...
    void setDelegate(jdk.internal.reflect.ConstructorAccessorImpl delegate) {
